...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/contact/member-[dept_id]-[user_id]': RouteRecordInfo<'/contact/member-[dept_id]-[user_id]', '/contact/member-:dept_id-:user_id', { dept_id: ParamValue<true>, user_id: ParamValue<true> }, { dept_id: ParamValue<false>, user_id: ParamValue<false> }>,
